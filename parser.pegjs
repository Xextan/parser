...
serial = expr:(modifiers? _? verbal (binder_phrase / tag_phrase)? ( _? serial / _? modifiers? verbal (binder_phrase / tag_phrase)? / (binder_phrase / tag_phrase))+) {return _node("serial", expr);}
