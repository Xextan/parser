...
sentence = expr:((illocutions? _? (fragment (XU _?)? / clause) / illocutions _? &(illocution / end_of_input / DS_terminator)) ( _? connective _? &illocution sentence)?) {return _node("sentence", expr);}
