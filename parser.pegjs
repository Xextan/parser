...
illocution = expr:(discursive_illocution / modal_illocution / z o i) {return _node("illocution", expr);}
...
binder = expr:(!verb (d o u / d o i / d e u / d e i / d a u / d a i / d o !V / d e !V / d a !V / p i !V)) {return _node("binder", expr);}
