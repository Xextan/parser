...
function newer_postprocessor(
    ...
    if (with_spaces)
         var value_substitution_map = {"_": "_", "initial_spaces": "_"};
    ...
    var special_selmaho = ["pronoun", "transmogrifier", "preposition_SS", "determiner_SS", "binder", "tag", "discursive_illocution",
						   ...
						   "dative_marker_SS", "tag_LS", "binder_LS", "LS_terminator"];
    ...
    var is_branch_removal_target = function (tree) {
        if (!with_spaces && among(tree[0], ["_", "initial_spaces"]))
            return true;
